...
author: "MBAN 5560 - Machine Learning"
date: today
format: 
  html:
...
ggplot(df_train, aes(x = x, y = y)) +
  ...
  geom_line(aes(y = f_true), color = "red", size = 1, linetype = "dashed", alpha = 0.7) +
  geom_vline(xintercept = bin_w1$breaks, color = "gray70", linetype = "dotted", alpha = 0.5) +
  ...
  labs(
    ...
    subtitle = "Green: Bin means connected | Red dashed: True relationship | Gray: Bin boundaries",
    x = "X",
    y = "Y"
  ) +
  theme_minimal()
...
ggplot(df_train, aes(x = x, y = y)) +
  geom_point(alpha = 0.4, color = "steelblue") +
  geom_line(aes(y = f_true), color = "red", size = 1, linetype = "dashed", alpha = 0.7) +
  geom_vline(xintercept = bin_w2$breaks, color = "gray70", linetype = "dotted", alpha = 0.5) +
  ...
  labs(
    ...
    subtitle = "Green: Bin means connected | Red dashed: True relationship",
    x = "X",
    y = "Y"
  ) +
  theme_minimal()
...
ggplot(df_train, aes(x = x, y = y)) +
  geom_point(alpha = 0.4, color = "steelblue") +
  geom_line(aes(y = f_true), color = "red", size = 1, linetype = "dashed", alpha = 0.7) +
  geom_vline(xintercept = bin_w4$breaks, color = "gray70", linetype = "dotted", alpha = 0.5) +
...
ggplot(df_train, aes(x = x, y = y)) +
  geom_point(alpha = 0.4, color = "steelblue") +
  geom_line(aes(y = f_true), color = "red", size = 1, linetype = "dashed", alpha = 0.7) +
  geom_vline(xintercept = bin_w7$breaks, color = "gray70", linetype = "dotted", alpha = 0.5) +
...
ggplot(df_train, aes(x = x, y = y)) +
  geom_point(alpha = 0.4, color = "steelblue") +
  geom_line(aes(y = f_true), color = "red", size = 1, linetype = "dashed", alpha = 0.7) +
  geom_vline(xintercept = bin_w10$breaks, color = "gray70", linetype = "dotted", alpha = 0.5) +
...
### From Bin Smoother to LOESS: Why Improve?

The bin smoother has several **limitations**:

1. **Discontinuities**: The fitted function jumps at bin boundaries
2. **No weighting**: All points in a bin contribute equally, even those at edges
3. **Inefficient**: Information at bin boundaries is not shared between adjacent bins
4. **Step function**: Connecting midpoints helps, but the underlying prediction is still piecewise constant

**LOESS improves on this by:**

1. Using **overlapping windows** centered at each prediction point
2. **Weighting** observations by distance (closer points matter more)
3. Fitting **local polynomials** instead of just computing means
4. Producing a **smooth continuous curve**

Now let's see how LOESS addresses these limitations...
